...
//This suite uses the TimesheetRecordsForFilter fixtures as well as those it depends on.
//To load it, run:
//>php bin/console doctrine:fixtures:load --group=timesheetRecordForFilter
...
def setUp() {
	...
	//Navigate to the right page and tab
	WebUI.click(findTestObject('Navbar/btn_reports'))
	WebUI.click(findTestObject('Dashboard/hoursSummary_Component/s21_custom_time_frame/btn_Dashboard'))
	WebUI.delay(1)
}

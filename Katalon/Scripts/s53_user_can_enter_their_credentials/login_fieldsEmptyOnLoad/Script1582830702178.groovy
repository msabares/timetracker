...
//This test tests that the fields are all empty on initial page load
...
WebUI.verifyElementText(findTestObject('Object Repository/Login/input_Username'), "")

//verify password is empty
WebUI.verifyElementText(findTestObject('Object Repository/Login/input_passwd'), "")

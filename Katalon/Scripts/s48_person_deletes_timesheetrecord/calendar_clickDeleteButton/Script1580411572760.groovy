...
//click TSR
WebUI.click(findTestObject('Calendar/record4_Jan8_900 - 1200Conference'))

//verify that the TSR detail are displayed
WebUI.waitForElementVisible(findTestObject('Calendar/s49 Test Objects/conference_timesheetrecord_modal'), 
    0)

//cleck the delete button
WebUI.click(findTestObject('Calendar/s49 Test Objects/button_Delete'))

//verify popeover visible
...
//verify modal closed
WebUI.verifyElementNotPresent(findTestObject('Calendar/Page_SPFA Project Management/coference_modal'), 0)

//verify the timesheetorecord actually deleted on the database
WebUI.verifyElementNotPresent(findTestObject('Calendar/record4_Jan8_900 - 1200Conference'), 0)

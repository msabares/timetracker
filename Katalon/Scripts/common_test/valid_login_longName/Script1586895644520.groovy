...
//set username text
WebUI.setText(findTestObject('Object Repository/Login/input_Username'), 'ww@hotmail.com')

//set password text, need to escape the $'s
WebUI.setText(findTestObject('Object Repository/Login/input_passwd'), 'Wwww123!')
